...
var endpointMetadata = require('../../config/sdk')['getHistoryEnergyBboxLat1Lat1Lon1Lon1Lat2Lat2Lon2Lon2'];
...
module.exports = function (makeRequest) {
  return function (requestData, callback, config) {
    var runtimeConfig = config || connectorConfig.connectors['weatherbitio'];
